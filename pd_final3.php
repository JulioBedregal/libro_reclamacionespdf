...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 4, utf8_decode('RUC: 20605259091'), 0, 1, 'C');
        $this->Cell(0, 4, utf8_decode('Razón Social: IMPORT HERMOZA S.A.C.'), 0, 1, 'C');
        $this->Cell(0, 4, utf8_decode('Dirección: Av. Parra Nro. 407( Frente Alicorp) - Arequipa'), 0, 1, 'C');
